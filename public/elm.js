...
var _user$project$Components$break = A2(
	_elm_lang$html$Html$br,
	_elm_lang$core$Native_List.fromArray(
		[]),
	_elm_lang$core$Native_List.fromArray(
		[]));
var _user$project$Components$clickablePoint = F2(
	function (str, msg) {
		return A2(
			_elm_lang$html$Html$p,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('point clickable'),
...
var _user$project$Components$ignorablePoint = function (str) {
	return A2(
		_elm_lang$html$Html$p,
		_elm_lang$core$Native_List.fromArray(
			[
...
var _user$project$Ports$draw = _elm_lang$core$Native_Platform.outgoingPort(
	'draw',
	function (v) {
		return v;
	});
...
var _user$project$View$view = function (m) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Components$ignorablePoint('Dank'),
				_user$project$Components$break,
				A2(_user$project$Components$clickablePoint, 'Draw', _user$project$Types$Draw),
				_user$project$Components$break,
				A2(
				_elm_lang$html$Html$canvas,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$id('number-1-canvas')
					]),
				_elm_lang$core$Native_List.fromArray(
					[]))
			]));
...
var _user$project$Main$update = F2(
	function (message, model) {
		...
		return {
			ctor: '_Tuple2',
			_0: model,
			_1: _user$project$Ports$draw('get draw!')
		};
	});
	...
	main: _elm_lang$html$Html_App$program(
		{
			init: {
				ctor: '_Tuple2',
				_0: _user$project$Types$Model('Elm 0.17 Gulp Coffeescript Stylus Lodash Browserify Boilerplate!'),
